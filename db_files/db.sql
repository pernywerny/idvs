...
-- Dumping data for table idvs_portal.auth_permission: ~48 rows (approximately)
INSERT IGNORE INTO `auth_permission` (`id`, `name`, `content_type_id`, `codename`) VALUES
	(1, 'Can add log entry', 1, 'add_logentry'),
	(2, 'Can change log entry', 1, 'change_logentry'),
	(3, 'Can delete log entry', 1, 'delete_logentry'),
...
-- Dumping data for table idvs_portal.django_admin_log: ~10 rows (approximately)
INSERT IGNORE INTO `django_admin_log` (`id`, `action_time`, `object_id`, `object_repr`, `action_flag`, `change_message`, `content_type_id`, `user_id`) VALUES
...
-- Dumping data for table idvs_portal.django_content_type: ~12 rows (approximately)
INSERT IGNORE INTO `django_content_type` (`id`, `app_label`, `model`) VALUES
	(1, 'admin', 'logentry'),
	(3, 'auth', 'group'),
	(2, 'auth', 'permission'),
...
-- Dumping data for table idvs_portal.django_migrations: ~28 rows (approximately)
INSERT IGNORE INTO `django_migrations` (`id`, `app`, `name`, `applied`) VALUES
...
-- Dumping data for table idvs_portal.django_session: ~1 rows (approximately)
INSERT IGNORE INTO `django_session` (`session_key`, `session_data`, `expire_date`) VALUES
